            ...
            <React.Fragment>
                <div className="card" >
                    ...
                    <div className="p-des">
                        ...
                        <p><strong>Purchase Price : </strong>{this.props.price} ATC</p>
                        <p><strong>Rent Price : </strong>{this.props.rentPrice} ATC</p>
                        <p><strong>Rent Duration : </strong>{this.props.days} Day(s)</p>
